<template>
  <svg viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      ...
      <linearGradient id="pa_paint0_linear" x1="71" y1="96.0002" x2="15" y2="-40.9998" gradientUnits="userSpaceOnUse">
        <stop stop-color="#742774" />
        <stop offset="1" stop-color="#BB35A4" />
      </linearGradient>
      <linearGradient id="pa_paint1_linear" x1="32" y1="0.0002436" x2="78" y2="96.0002" gradientUnits="userSpaceOnUse">
        <stop stop-color="#E48CC7" />
        <stop offset="1" stop-color="#D467B9" />
      </linearGradient>
      <linearGradient id="pa_paint2_linear" x1="62" y1="29.0002" x2="76" y2="72" gradientUnits="userSpaceOnUse">
      ...
      <clipPath id="pa_clip2">
        <rect width="96" height="96" fill="white" transform="translate(0 0.00012207)" />
      </clipPath>
    </defs>
    <g clip-path="url(#pa_clip0)">
      <g clip-path="url(#pa_clip1)">
        <g clip-path="url(#pa_clip2)">
          <mask id="pa_mask0" mask-type="alpha" maskUnits="userSpaceOnUse" x="-1" y="1" width="97" height="94">
          ...
          <g mask="url(#pa_mask0)">
            <path d="M40 96L-2 48L40 0L82 48L40 96Z" fill="url(#pa_paint0_linear)" />
            ...
            <path d="M53.999 0L97.999 48L53.999 96L34.4767 74.7029C33.0748 73.1736 33.0748 70.8264 34.4767 69.2971L51.5214 50.7029C52.9232 49.1736 52.9232 46.8264 51.5214 45.2971L34.4767 26.7029C33.0748 25.1736 33.0748 22.8264 34.4767 21.2971L53.999 0Z" fill="url(#pa_paint1_linear)" />
            <path d="M73.0514 27.2167C74.6367 25.4872 77.3633 25.4872 78.9486 27.2167L98 48L78.9486 68.7833C77.3633 70.5128 74.6367 70.5128 73.0514 68.7833L57.7165 52.0543C55.6137 49.7604 55.6137 46.2396 57.7165 43.9457L73.0514 27.2167Z" fill="url(#pa_paint2_linear)" />
          </g>
        </g>
      </g>
    </g>
